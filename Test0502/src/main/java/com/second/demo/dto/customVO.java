...
public class customVO {
	...
	public String getShort_custom() {
		return short_custom;
	}
	public void setShort_custom(String short_custom) {
		this.short_custom = short_custom;
	}
